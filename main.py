...
def __main__:
 account_name=input("Margoth_230oz ? ")
   if account_name=="":Margoth_230oz
     print('Margoth oz ')
 ...
 print("");print("[1] - Likes 5000 ");print("5000");print("[2] - Views 3000");print("");print("[1] - Followers 7000 ");print("");
   choose=input('> ')
       if choose=="1":
